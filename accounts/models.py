...
class User(AbstractUser):
    ...
    company_reg_number = models.CharField(max_length=50, blank=True, help_text="Company registration number (optional)")
    sa_id_passport = models.CharField(max_length=50, blank=True, help_text="SA ID / Passport number")
    sa_id_passport_copy = models.FileField(upload_to='sa_id_copies/', blank=True, help_text="Copy of SA ID / Passport (PDF, JPG, PNG)")
